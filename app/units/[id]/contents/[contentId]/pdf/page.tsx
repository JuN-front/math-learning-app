...
function PDFViewer({ params }: { params: { id: string; contentId: string } }) {
  ...
  }, [status, params.contentId, fileType]);
        ...
        <div className="card flex-1 overflow-hidden" style={{ minHeight: '70vh' }}>
          {!pdfPath ? (
            ...
            <div className="flex flex-col items-center justify-center h-80 text-red-400">
              ...
              <a href={pdfPath} target="_blank" rel="noopener noreferrer" className="mt-3 text-sm text-blue-600 hover:underline">
                別タブで開く
              </a>
            </div>
          ) : (
